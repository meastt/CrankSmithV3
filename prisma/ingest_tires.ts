...
async function main() {
    const dataPath = path.join(process.env.HOME || '', '.gemini/antigravity/brain/63f1098d-3482-4a0a-b85c-1e6772b94e9c/data_ingestion_tires.json');
    ...
    console.log(`Ingesting ${tires.length} Tires...`);
    ...
    for (const tire of tires) {
        ...
        if (!exists) {
            ...
            console.log(`Skipped Tire (Exists): ${name}`);
        }
    }

    console.log('Tire ingestion finished.');
}
